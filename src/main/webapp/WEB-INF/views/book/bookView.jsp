...
<body>
	...
	<c:if test="${sessionScope.id eq null}">
		<jsp:forward page="/cenlibrary/member/memberLogin"/>
	</c:if>
	<div class="box1">

		<!-- 도서 상세정보 -->
		<form action="/cenlibrary/mybook/mybookAdd.do" method="post">
				...
				<tr>
					...
					<c:choose>
							<c:when test="${empty view.bookimg}">
								<img src="/cenlibrary/resources/img/booknull.jpg" width="225px" height="325px"/>
							</c:when>

							<c:when test="${not empty view.bookimg}">
								<img src="/cenlibrary/resources/${view.bookimg}" width="225px" height="325px"/>
							</c:when>
						</c:choose>
						</td>
				...
				<tr>
					<td width="130px"><c:choose>
							<c:when test="${dto.rating eq '1'}">
								<img src="/cenlibrary/resources/img/1star.png" alt="1점" width="130px">
							</c:when>

							<c:when test="${dto.rating eq '2'}">
								<img src="/cenlibrary/resources/img/2star.png" alt="2점" width="130px">
							</c:when>

							<c:when test="${dto.rating eq '3'}">
								<img src="/cenlibrary/resources/img/3star.png" alt="3점" width="130px">
							</c:when>

							<c:when test="${dto.rating eq '4'}">
								<img src="/cenlibrary/resources/img/4star.png" alt="4점" width="130px">
							</c:when>

							<c:when test="${dto.rating eq '5'}">
								<img src="/cenlibrary/resources/img/5star.png" alt="5점" width="130px">
							</c:when>
