...
<link rel="stylesheet" href="/cenlibrary/resources/css/bookadminpro.css">
</head>
<body>
				...
				<tr>
					...
					<td><c:choose>
							<c:when test="${empty view.bookimg}">
								<img src="/cenlibrary/resources/img/booknull.jpg" width="200px" height="290px"></img>
							</c:when>

							<c:when test="${not empty view.bookimg}">
								<img src="/cenlibrary/resources/${view.bookimg}" width="200px" height="290px"></img>
							</c:when>
						</c:choose>
					</td>
				</tr>
