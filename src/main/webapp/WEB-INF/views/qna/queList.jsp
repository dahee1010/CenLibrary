...
<link rel="stylesheet" href="/cenlibrary/resources/css/boardlist.css">
</head>
<body>
		...
		<c:forEach items="${list}" var="dto" varStatus="status">
			<tr>
				...
				<c:choose>
					...
					<img src="/cenlibrary/resources/img/lock.png" id="lock"/>
	...
	<a href="queWrite"><input type="button" value="글작성"></a>
